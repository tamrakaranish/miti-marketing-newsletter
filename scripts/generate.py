...
# ----------------------------
# Add your custom message here. Set to None or empty string to disable.
# This will appear at the top of the newsletter, right after the title.
...
# Set to None to disable custom message
# CUSTOM_MESSAGE = None
